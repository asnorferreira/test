...
const slides = [
  ...
  },
  {
    ...
    image: "https://www.gigroupholding.com/portugal/wp-content/uploads/sites/10/2025/08/duas_pessoas_a_conversar-scaled.jpg",
  },
  {
    id: 4,
    title: "Soluções estratégicas para o crescimento da sua empresa",
    description:
      "Oferecemos soluções personalizadas e serviços avançados para melhorar a produtividade, eficiência, flexibilidade e competitividade de nossos clientes",
    image: "https://www.gigroupholding.com/brasil/wp-content/uploads/sites/3/2022/01/gigroupholding_gigroup_recrutamento_selecao_temporarios_permanentes.jpg",
  },
]
      ...
      <div className="container relative mx-auto flex h-full items-center px-4">
        <div className="max-w-2xl">
          ...
          <div className="flex gap-4">
            <Button
              size="lg"
              className="px-8 text-white bg-[#2563eb] hover:bg-[#1e40af]"
              onClick={() => {
