...
import { GESTOR_SESSION_STORAGE_KEY, RH_SESSION_STORAGE_KEY } from "@/packages/web/lib/constants"
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <label className="text-sm font-medium text-gray-700">
                ...
                <input
                  ...
                  name="email"
                  required
                  className="mt-3 w-full rounded-2xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm text-gray-900 outline-none transition focus:border-[#2563eb] focus:bg-white"
              ...
              <button
                ...
                className="mt-4 inline-flex w-full items-center justify-center gap-2 rounded-full bg-[#2563eb] px-6 py-3 text-sm font-semibold uppercase tracking-[0.3em] text-white shadow-lg transition hover:bg-[#1d4ed8] disabled:opacity-60"
              >
