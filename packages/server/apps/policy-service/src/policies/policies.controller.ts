import { Controller, Get, Param, Post, Patch, Delete, Body, Req, UseGuards, ParseUUIDPipe, HttpCode, HttpStatus } from '@nestjs/common';
...
export class PoliciesController {
  ...
  @Patch(':id')
  @Roles(UserRole.ADMIN, UserRole.QA, UserRole.SUPERVISOR)
  @ApiOperation({ summary: 'Atualiza uma política existente.' })
  ...
  @ApiOperation({ summary: 'Remove uma política.' })
