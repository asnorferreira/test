...
const services = [
  ...
  {
    category: "Saúde",
    items: ["Dentista", "Auxiliar bucal", "Enfermeiro", "Agente de saúde"],
  },
  {
...
export function Header() {
  ...
  const linkClasses = clsx(
    ...
    isAtTop ? "text-white hover:text-white/80" : "text-gray-700 hover:text-[#2563eb]",
  )

  const logoClasses = clsx(
    "font-bold transition-all duration-300",
    isAtTop ? "text-3xl text-white" : "text-2xl text-[#1e3a8a]",
  )
      ...
      <div className="container mx-auto px-4">
        <div
          className={clsx(
            ...
            isAtTop ? "bg-white/12 border-white/40 backdrop-blur-3xl shadow-lg" : "bg-white border-transparent shadow-lg",
          )}
        >
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className={clsx(
                "transition-colors",
                isAtTop ? "text-[#60a5fa] hover:text-[#2563eb]" : "text-gray-700 hover:text-[#60a5fa]",
              )}
            >
